...
var firstname = jQuery('#field43284834-first').val();
        ...
        if (jQuery('.fspr_register_error').length) jQuery('.fspr_register_error').remove();
        ...
        if (jQuery('.fspr_register_error').length) e.preventDefault();
});
}
...
if (jQuery('.fspr_comment_error').length) jQuery('.fspr_comment_error').remove();
        //Name field validation
        if (jQuery('#commentform #author').length){
var name = jQuery('#commentform #author').val();
...
if (jQuery('.fspr_comment_error').length) e.preventDefault();
});
}
...
if (jQuery('.fspr_user_profile_upload_error').length) jQuery('.fspr_user_profile_upload_error').remove();
...
var firstname = jQuery('#first_name').val();
        ...
        if (jQuery('.fspr_user_profile_error').length) jQuery('.fspr_user_profile_error').remove();
        ...
        if (jQuery('.fspr_user_profile_error').length || jQuery('.fspr_user_profile_upload_error').length) e.preventDefault();
});
}
