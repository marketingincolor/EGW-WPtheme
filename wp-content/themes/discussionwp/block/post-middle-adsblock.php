...
if ($total_post >= $post_per_section) {
    ...
    for ($i = 1; $i <= $no_of_adds; $i++) {
        ...
        <div  class="fsp-ads-homepage hidden-sm hidden-md hidden-lg"  id="adv_row_<?php echo $i; ?>" <?php if ($i != 1) { ?> style="display:none;clear:both" <?php } else { ?> style="clear:both" <?php } ?>>  
            <?php
         ...
         */
        ?>
        <div  class="fsp-ads-homepage hidden-xs"  id="mob_adv_row_<?php echo $i; ?>" <?php if ($i != 1) { ?> style="display:none;clear:both" <?php } else { ?> style="clear:both" <?php } ?>>  
            <?php
            if (function_exists('drawAdsPlace'))
