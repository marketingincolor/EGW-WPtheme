<div class="fsp-welcome-branch">
    <div class="fsp-branch-title"><h4>Welcome to The Villagess!</h4></div>
    <div class="fsp-branch-content">        
        <ul>
            <li><a href = "<?php echo network_site_url(); ?>register"><i class="fa fa-check" aria-hidden="true"></i> Join This Village?</a></li>
