            ...
            <div class="mkd-column1 mkd-content-left-from-sidebar">
                <div class="mkd-column-inner">
                                                    ...
                                                    <div class="vc_column-inner ">
                                                        <div class="wpb_wrapper">
                                                            ...
                                                            <div class="wpb_text_column wpb_content_element ">
                                                                <div class="wpb_wrapper">
                                                                    <h5><?php
                                                                        $title = get_field_object('address');
                                                                        echo $title['label'];
                                                                        ?></h5>
                                                                </div>
                                                            </div>
                    ...
                    <div style="" class="vc_row wpb_row vc_row-fluid mkd-section vc_custom_1457353735985 mkd-content-aligment-left">
                           <?php echo do_shortcode("[contact-form-7 id=504 title='Contact']"); ?>
                    </div>
                </div>
            </div>
            <div class="mkd-column2">
                <div class="mkd-column-inner">
                    <aside class="mkd-sidebar"> <?php get_sidebar(); ?> </aside>
                </div>
            </div>
        </div>
    </div>
