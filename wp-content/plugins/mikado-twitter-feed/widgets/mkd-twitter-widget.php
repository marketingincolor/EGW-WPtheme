...
class MikadoTwitterWidget extends WP_Widget {
    ...
    public function __construct() {
        parent::__construct(
            ...
            array( 'description' => esc_html__( 'Display tweets', 'discussionwp' ) )
        );
    ...
    public function widget($args, $instance) {    	
        ...
        $general_style = !empty($general_style) ? 'mkd-twitter-style-'.$general_style : '';
        ...
        if($twitter_api->hasUserConnected()) {
            ...
            if($response->status) {
                if(is_array($response->data) && count($response->data)) { ?>
                    <ul class="mkd-twitter-widget <?php echo esc_attr($general_style); ?>">
                    <?php foreach($response->data as $tweet) { ?>
                        <li>
                        	<span class="mkd-twitter-icon social_twitter"></span>
                            <p class="mkd-tweet-text">
            ...
            esc_html_e('It seams that you haven\'t connected with your Twitter account', 'discussionwp');
        }
