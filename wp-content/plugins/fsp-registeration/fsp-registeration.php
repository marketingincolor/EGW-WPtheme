...
function custom_user_profile_fields($current_user, $userdata,$user_ID){
    ...
    <form name="profile" action="" method="post" enctype="multipart/form-data">
        <?php
        echo wp_nonce_field('update-profile_' . $user_ID);
        echo $user_ID;
        ?>
    ...
    <?php endif; ?>
            ...
            <tr>
                <td>Nick name <span style="color: #F00">*</span></td>
                <td><input type="text" name="nickname" class="mid2" id="nickname" value="<?php echo $userdata->nickname ?>" style="width: 300px;" /></td>
            </tr>
            <tr>
            ...
            <tr>
                <td align="center" colspan="2"><input type="submit" name="profile_submit" value="Update" /></td>
            </tr>
        </table>
