...
<?php wp_nonce_field('wp-postratings_templates'); ?>
        ...
        <?php
        /* The Template Rating Values */
        $ptv = "%RATINGS_IMAGES_VOTE%";
        $ptt = "%RATINGS_IMAGES%";
        $ptp = "%RATINGS_IMAGES%";
        $ptn = "%RATINGS_IMAGES_VOTE%";
        $pth = '<li><a href="%POST_URL%" title="%POST_TITLE%">%POST_TITLE%</a> %RATINGS_IMAGES% (%RATINGS_AVERAGE% out of %RATINGS_MAX%)</li>';
        $ptm = '<li><a href="%POST_URL%"  title="%POST_TITLE%">%POST_TITLE%</a> - %RATINGS_USERS% votes</li>';
        ...
        $ptv_assign = esc_attr(stripslashes(get_option('postratings_template_vote')));
        $ptt_assign = esc_attr(stripslashes(get_option('postratings_template_text')));
        $ptp_assign = esc_attr(stripslashes(get_option('postratings_template_permission')));
        $ptn_assign = esc_attr(stripslashes(get_option('postratings_template_none')));
        $pth_assign = esc_attr(stripslashes(get_option('postratings_template_highestrated')));
        $ptm_assign = esc_attr(stripslashes(get_option('postratings_template_mostrated')));
...
<?php _e('Allowed Variables:', 'wp-postratings'); ?>
                ...
                <td><textarea cols="80" rows="15" id="postratings_template_vote" name="postratings_template_vote"><?php if (empty($ptv_assign)) {
    echo $ptv;
} else {
    echo $ptv_assign;
} ?></textarea></td>
...
<?php _e('Allowed Variables:', 'wp-postratings'); ?>
                ...
                <td><textarea cols="80" rows="15" id="postratings_template_text" name="postratings_template_text"><?php if (empty($ptt_assign)) {
    echo $ptt;
} else {
    echo $ptt_assign;
} ?></textarea></td>
...
<?php _e('Allowed Variables:', 'wp-postratings'); ?>
                ...
                <td><textarea cols="80" rows="15" id="postratings_template_permission" name="postratings_template_permission"><?php if (empty($ptp_assign)) {
    echo $ptp;
} else {
    echo $ptp_assign;
} ?></textarea></td>
...
<?php _e('Allowed Variables:', 'wp-postratings'); ?><br />
                ...
                <td><textarea cols="80" rows="15" id="postratings_template_none" name="postratings_template_none"><?php if (empty($ptn_assign)) {
    echo $ptn;
} else {
    echo $ptn_assign;
} ?></textarea></td>
...
<?php _e('Allowed Variables:', 'wp-postratings'); ?><br />
                ...
                <td><textarea cols="80" rows="15" id="postratings_template_highestrated" name="postratings_template_highestrated"><?php if (empty($pth_assign)) {
    echo $pth;
} else {
    echo $pth_assign;
} ?></textarea></td>
...
<?php _e('Allowed Variables:', 'wp-postratings'); ?><br />
                ...
                <td><textarea cols="80" rows="15" id="postratings_template_mostrated" name="postratings_template_mostrated"><?php if (empty($ptm_assign)) {
    echo $ptm;
} else {
    echo $ptm_assign;
} ?></textarea></td>
