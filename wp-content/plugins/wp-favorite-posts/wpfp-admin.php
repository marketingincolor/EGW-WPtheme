        ...
        <div class="meta-box-sortables">
            ...
            <form action="" method="post">
                ...
                <div class="postbox">
                    ...
                    <div class="inside" style="display: block;">
                        <?php
                        $wpfp_options['add_favorite'] = "Save this Story";
                        $wpfp_options['added'] = "Added to favorites!";
                        $wpfp_options['remove_favorite'] = "Removed from Storage";
                        $wpfp_options['removed'] = "Removed from Storage!";
                        $wpfp_options['clear'] = "Clear Storage";
                        $wpfp_options['cleared'] = "<p>Article is cleared from storage!</p>";
                        $wpfp_options['favorites_empty'] = "Storage article list is empty.";
                        $wpfp_options['cookie_warning'] = "Your posts saved to your browsers cookies. If you clear cookies also saved posts will be deleted.";
                        $wpfp_options['rem'] = "remove";
                        $wpfp_options['text_only_registered'] = "Only registered users can save!";
                        ?>
                        ...
                        <table class="form-table">
                            ...
                            <tr>
                                <th><?php _e("Text for added", "wp-favorite-posts") ?></th><td><input type="checkbox"  <?php if ($wpfp_options['added'] == 'show remove link') echo "checked='checked'"; ?> name="show_remove_link" onclick="jQuery('#added').val('');
                        jQuery('#added').toggle();" value="show_remove_link" id="show_remove_link" /> <label for="show_remove_link">Show remove link</label>
                            ...
                            <tr>
                                ...
                                <td><input type="checkbox" <?php if ($wpfp_options['removed'] == 'show add link') echo "checked='checked'"; ?> name="show_add_link" id="show_add_link" onclick="jQuery('#removed').val('');
                                        jQuery('#removed').toggle();" value='show_add_link' /> <label for="show_add_link">Show add link</label>
                                    <br />
